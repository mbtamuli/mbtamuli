...
- [warm-metal/container-image-csi-driver](https://github.com/warm-metal/container-image-csi-driver) ([v2.0.0](https://github.com/warm-metal/container-image-csi-driver/releases/tag/v2.0.0), 1 month ago) - Kubernetes CSI driver for mounting image
- [mbtamuli/csi-quickstart](https://github.com/mbtamuli/csi-quickstart) ([v1.0.0](https://github.com/mbtamuli/csi-quickstart/releases/tag/v1.0.0), 8 months ago) - Educational/learning project for Container Storage Interface
- [mbtamuli/github-actions-pocs](https://github.com/mbtamuli/github-actions-pocs) ([helm-chart-hello-world-0.7.0](https://github.com/mbtamuli/github-actions-pocs/releases/tag/helm-chart-hello-world-0.7.0), 8 months ago) - Various proofs of concept examples using Github Actions 🤖
